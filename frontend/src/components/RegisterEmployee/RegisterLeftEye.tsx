...
export const RegisterLeftEye:React.FC = () => {
  ...
  const onFinish = (values : userLeftEye) => {
    
    const left_eye = values.imageupload[0];
    updateFormData({
      leyes: left_eye
    });
    setIncrementStep();
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
        <div className='my-10'>
            <h1 className='text-secondary font-secondary text-xl'>Upload the Lefteye of selected teacher</h1>
        </div>
        <Form
            name="basic"
            className='w-[20rem]'
